...
public class FirstWFE___firstWFE_processChainProcessingAction_Action extends AbstractMd2Action {

    public FirstWFE___firstWFE_processChainProcessingAction_Action() {
		super("FirstWFE___firstWFE_processChainProcessingAction_Action");
	}
