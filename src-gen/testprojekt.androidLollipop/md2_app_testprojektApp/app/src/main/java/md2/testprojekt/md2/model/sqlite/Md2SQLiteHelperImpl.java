...
import md2.testprojekt.md2.model.sqlite.Md2DataContract.__ReturnStepStackEntry;
import md2.testprojekt.md2.model.sqlite.Md2DataContract.__ProcessChainControllerStateEntry;
...
public class Md2SQLiteHelperImpl extends SQLiteOpenHelper implements Md2SQLiteHelper {
	private static final String DATABASE_NAME = "testprojektapp.db";
