...
public class FirstWFE___firstWFE_startupAction_Action extends AbstractMd2Action {

    public FirstWFE___firstWFE_startupAction_Action() {
		super("FirstWFE___firstWFE_startupAction_Action");
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new FirstWFE___firstWFE_registerProcessChainActionEventTrigger_Action());
			var1.execute();
		...
		try {
			var2 = new Md2CallTask(new FirstWFE___processChainSetProcessChainFirstProcessChainAction_Action());
			var2.execute();
		}catch (Md2WidgetNotCreatedException e){
		...
		try {
			var3 = new Md2CallTask(new FirstWFE_firstWFE_init_Action());
			var3.execute();
		}catch (Md2WidgetNotCreatedException e){
