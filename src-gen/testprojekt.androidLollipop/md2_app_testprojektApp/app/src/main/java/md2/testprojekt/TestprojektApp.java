...
import md2.testprojekt.md2.model.sqlite.Md2SQLiteHelperImpl;
...
public class TestprojektApp extends Application {
	...
	public static Context getAppContext() {
        return TestprojektApp.context;
    }
    
	public static Md2SQLiteHelper getMd2SQLiteHelper() {
        if (sqLiteHelper == null)
            synchronized (TestprojektApp.class) {
                if (sqLiteHelper == null)
                    sqLiteHelper = new Md2SQLiteHelperImpl(TestprojektApp.getAppContext());
            }
        return sqLiteHelper;
    }
}
