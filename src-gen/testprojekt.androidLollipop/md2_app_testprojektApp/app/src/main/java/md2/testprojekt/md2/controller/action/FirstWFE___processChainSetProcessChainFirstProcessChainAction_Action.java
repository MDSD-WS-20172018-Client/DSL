...
package md2.testprojekt.md2.controller.action;

import md2.testprojekt.TestprojektApp;
import md2.testprojekt.R;
...
public class FirstWFE___processChainSetProcessChainFirstProcessChainAction_Action extends AbstractMd2Action {

    public FirstWFE___processChainSetProcessChainFirstProcessChainAction_Action() {
		super("FirstWFE___processChainSetProcessChainFirstProcessChainAction_Action");
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2AttributeSetTask("__processChainControllerStateProvider", "currentProcessChainStep", new Md2String("firstProcessChain__firstStep"));
			var1.execute();
		...
		try {
			var2 = new Md2CallTask(new FirstWFE___firstWFE_processChainExecuteStepAction_Action());
			var2.execute();
		}catch (Md2WidgetNotCreatedException e){
