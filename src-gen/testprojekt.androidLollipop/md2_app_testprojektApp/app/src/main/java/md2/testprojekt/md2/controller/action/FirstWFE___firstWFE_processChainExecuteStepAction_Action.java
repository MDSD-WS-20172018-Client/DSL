...
public class FirstWFE___firstWFE_processChainExecuteStepAction_Action extends AbstractMd2Action {

    public FirstWFE___firstWFE_processChainExecuteStepAction_Action() {
		super("FirstWFE___firstWFE_processChainExecuteStepAction_Action");
	}
