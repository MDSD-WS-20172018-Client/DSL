...
public class MainViewActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Md2Label mainView_info = (Md2Label) findViewById(R.id.MainView_info);
        mainView_info.setWidgetId(R.id.MainView_info);
        Md2WidgetRegistry.getInstance().addWidget(mainView_info);
    }
    ...
    protected void onStart(){
        ...
        Md2Label mainView_info = (Md2Label) findViewById(R.id.MainView_info);
        Md2WidgetRegistry.getInstance().loadWidget(mainView_info);
    ...
    protected void onPause(){
        super.onPause();
        Md2Label mainView_info = (Md2Label) findViewById(R.id.MainView_info);
        Md2WidgetRegistry.getInstance().saveWidget(mainView_info);
    }
