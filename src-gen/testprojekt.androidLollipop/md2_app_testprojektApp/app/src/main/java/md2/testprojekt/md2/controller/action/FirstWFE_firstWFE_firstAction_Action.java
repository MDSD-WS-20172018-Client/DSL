...
public class FirstWFE_firstWFE_firstAction_Action extends AbstractMd2Action {

    public FirstWFE_firstWFE_firstAction_Action() {
		super("FirstWFE_firstWFE_firstAction_Action");
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new Md2FireEventAction("BasicEvent"));
			var1.execute();
