...
public class FirstWFE___firstWFE_registerProcessChainActionEventTrigger_Action extends AbstractMd2Action {

    public FirstWFE___firstWFE_registerProcessChainActionEventTrigger_Action() {
		super("FirstWFE___firstWFE_registerProcessChainActionEventTrigger_Action");
	}
